% % Code for reproducing Figure 4 and Supp. Figure 4.1
% % More information on the method used here can be found on Semedo et al.,
% % 2019.
...
for isource=1:2
    ...
    for itarget=1:2
        for ilearn=1:2
            ...
            aux = squeeze(mean(maxp(ises,:,isource,itarget,:),2));
            ...
            %%
            aux = squeeze(mean(ndim(ises,:,isource,itarget,:),2));
